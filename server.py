...
if __name__ == '__main__':
    ...
    os.putenv("DISPLAY", ":0")
    output = Popen(
        "export DISPLAY=:0; ffmpeg -loglevel fatal -f v4l2 -video_size 320x240 -r 25 -i /dev/video0 -f mpegts -vcodec mpeg1video -s 320x240 -b:v 1000k -bf 0 - | tee export DISPLAY=:0; >(ffplay -fs -)",
